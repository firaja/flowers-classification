...
This section reports the results obtained on the test set when
the best trained models are used as well as on training also on
validation set. The results are shown in table 3.
