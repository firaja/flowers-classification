...
InceptionV3    & 64 & Adam & $[10^{-5}, 10^{-3}]$ & Triangular  & 2 & 91.86\% \\ \hline
EfficientNetB4 & 16 & Adam & $[10^{-5}, 10^{-3}]$ & Triangualr2 & 4 & 94.89\% \\ \hline
\end{tabular}%
}
\end{table}

For the second experiment the best model was chosen


\begin{figure}[!htb]
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=1\linewidth]{images/param_acc.png}
     \caption{Interpolation for Data 1}\label{Fig:Data1}
   \end{minipage}\hfill
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=1\linewidth]{images/time_acc.png}
