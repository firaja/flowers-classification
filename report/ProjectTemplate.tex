...
\documentclass[12pt, xcolor=table]{article}
...
% If you use beamer only pass "xcolor=table" option, i.e. \documentclass[{beamer}
\begin{table}[]
\centering
\caption{}
\label{tab:my-table}
...
\multicolumn{4}{|c|}{\cellcolor[HTML]{3166FF}{\color[HTML]{FFFFFF} \textbf{ResNet-18}}} &
  \multicolumn{4}{c|}{\cellcolor[HTML]{3166FF}{\color[HTML]{FFFFFF} \textbf{InceptionV3}}} &
  \multicolumn{4}{c|}{\cellcolor[HTML]{3166FF}{\color[HTML]{FFFFFF} \textbf{EfficientNetB4}}} \\ \hline
\rowcolor[HTML]{DAE8FC} 
\multicolumn{1}{|l|}{\cellcolor[HTML]{DAE8FC}\textbf{Optimizer}} &
  \multicolumn{1}{l|}{\cellcolor[HTML]{DAE8FC}\textbf{Scheduler}} &
  \multicolumn{1}{l|}{\cellcolor[HTML]{DAE8FC}\textbf{Step size}} &
  \textbf{Test accuracy} &
  \multicolumn{1}{l|}{\cellcolor[HTML]{DAE8FC}\textbf{Optimizer}} &
  \multicolumn{1}{l|}{\cellcolor[HTML]{DAE8FC}\textbf{Scheduler}} &
  \multicolumn{1}{l|}{\cellcolor[HTML]{DAE8FC}\textbf{Step size}} &
