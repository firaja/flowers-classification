...
The subdivision of the dataset defined in the original publication has been maintained, in particular there are:
\begin{itemize}
\item $1\,020$ images in the training set
\item $1\,020$ images in the validation set
\item $6\,149$ images in the test set
\end{itemize}
...
The difficulty of operating on a dataset of this type is evident: the number of images for training is limited while the test set is large.
