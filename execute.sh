...
python3 trainer.py --epoch 6 --mp --arch inceptionv3 --batch 16 --step 2 --opt SGD --clr triangular
python3 trainer.py --epoch 6 --da --mp --arch inceptionv3 --batch 16 --step 2 --opt SGD --clr triangular
python3 trainer.py --epoch 6 --mp --arch inceptionv3 --batch 16 --step 2 --opt Adam --clr triangular 
python3 trainer.py --epoch 6 --da --mp --arch inceptionv3 --batch 16 --step 2 --opt Adam --clr triangular
python3 trainer.py --epoch 6 --mp --arch inceptionv3 --batch 16 --step 4 --opt SGD --clr triangular
python3 trainer.py --epoch 6 --da --mp --arch inceptionv3 --batch 16 --step 4 --opt SGD --clr triangular
python3 trainer.py --epoch 6 --mp --arch inceptionv3 --batch 16 --step 4 --opt Adam --clr triangular 
python3 trainer.py --epoch 6 --da --mp --arch inceptionv3 --batch 16 --step 4 --opt Adam --clr triangular